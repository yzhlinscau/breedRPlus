#' @title Tree spacing trial dataset2
#' 
...
#' @name PrSpa
#' @usage data(dfm2)
#' @format one dataset with 17 variables
#' \describe{
#'  \item{TreeID}{Tree Sample code}
#'  \item{Mum}{Tree mum code}
#'  \item{Dad}{Tree dad code} 
...
#'  \item{lt}{a numeric vector}
#'  \item{str}{a numeric vector}
#' }
NULL